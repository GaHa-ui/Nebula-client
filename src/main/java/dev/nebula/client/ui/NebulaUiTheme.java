...
public final class NebulaUiTheme {
    ...
    private final NebulaMenuSpec mainMenu;
    private final NebulaSplashSpec splash;

    private NebulaUiTheme(String logoTexture, List<String> panoramaFrames, List<NebulaButtonLink> links, NebulaMenuSpec mainMenu, NebulaSplashSpec splash) {
    ...
    public static NebulaUiTheme createDefault() {
        return new NebulaUiTheme(
                ...
                NebulaMenuSpec.defaultSpec(),
                NebulaSplashSpec.defaultSpec());
    }
    ...
    public NebulaMenuSpec mainMenu() { return mainMenu; }
    public NebulaSplashSpec splash() { return splash; }
